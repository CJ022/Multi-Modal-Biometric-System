...
def faceDetection(test_img): 
    ...
    #path to haar caascade
    face_haar = cv2.CascadeClassifier(cv2.data.haarcascades + 'haarcascade_frontalface_default.xml')
    #face_haar=cv2.CascadeClassifier(r'C:\Users\246687\Desktop\BE Final Year Project\Face-Recognition_lpbh\haarcascade_frontalface_alt.xml') #Give path to haar classifier as i have given
